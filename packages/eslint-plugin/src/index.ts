...
import noDefaultIconComponent from './rules/no-default-icon-component'
...
export default {
  rules: {
    ...
    'no-default-icon-component': noDefaultIconComponent,
  },
  configs: {
    recommended: {
      plugins: ['@yafh'],
      rules: {
        ...
        '@yafh/no-default-icon-component': 'error',
